...
internal enum Assets {
  ...
  internal enum Images {
    internal static let europe = ImageAsset(name: "europe")
    internal static let flagPlaceholder = ImageAsset(name: "flag_placeholder")
    internal static let icClose = ImageAsset(name: "ic_close")
    internal static let reweLogo = ImageAsset(name: "rewe_logo")
